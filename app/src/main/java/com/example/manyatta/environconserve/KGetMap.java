...
public class KGetMap extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kget_map);
    ...
    private void carrySend() {
        ...
        Intent intent = new Intent(this,KPost.class);
