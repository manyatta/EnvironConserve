...
public class MGetMap extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mget_map);
    ...
    private void carrySend() {
        ...
        Intent intent = new Intent(this,MPost.class);
